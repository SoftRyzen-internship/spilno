...
export const Footer: React.FC = () => {
  ...
  return (
    <footer className="md:delimeter bg-darkBg pt-[60px] text-center text-white md:pt-20 md:after:bg-accent xl:pt-16">
      <div className="container mx-auto">
        ...
        <div className="delimeter text-xs/[1.5] md:text-sm/[1.25] xl:flex xl:items-center xl:justify-between xl:py-5">
          ...
          <div className="delimeter md:flex md:items-center md:justify-between xl:gap-[76px] xl:after:hidden smOnly:py-4 mdOnly:py-8">
            <a
              href={policy.href}
